...
@section('title', 'اعتبار سنجی تراکنش')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-center mb-5">
                            ...
                            <h5 class="mt-3 text-success">پرداخت شما با موفقیت انجام شد شماره پیگیری: {{ $ref_number }}</h5>
                            @else   
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            @else
                            <a href="{{ route('card.index') }}" class="btn btn-primary">سبد خرید</a>
                            @endif
