...
@section('content')
    ...
    <form action="{{ route('product.store') }}" enctype="multipart/form-data" method="POST" class="row gy-4 mb-5">
        ...
        <div class="col-md-3">
            ...
            <input name="sale_price" value="{{ old('sale_price') }}" type="text" class="form-control" />
            <div class="form-text text-danger">
                @error('sale_price')
                    {{ $message }}
                @enderror
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="date_on_sale_from" value="{{ old('date_on_sale_from') }}" type="text"
                class="form-control" />
            <div class="form-text text-danger">
        ...
        <div class="col-md-3">
            ...
            <input data-jdp name="date_on_sale_to" value="{{ old('date_on_sale_to') }}" type="text"
                class="form-control" />
            <div class="form-text text-danger">
